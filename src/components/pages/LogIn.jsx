        ...
        <div className="flex flex-col gap-y-10 bg-transparent">
          ...
          <form onSubmit={(e) => e.preventDefault()} method="post" className="flex flex-col gap-y-7 font-[poppins]">
            <input
              value={email}
              onChange={(e) => {
                setLoginFormInputs({ ...loginFormInputs, email: e.target.value });
              }}
              type="text"
              name="email"
              id="email"
            ...
            <div className="flex justify-between items-center">
              <input
                ...
                type="submit"
                value="Log In"
                className="py-4 px-10 rounded-[4px] text-base font-medium  bg-[--secondaryThree-clr] hover:bg-[--hoverBtnOne-clr] text-[--textOne-clr] cursor-pointer"
              />
              <a href="/" className="font-[poppins] text-base font-normal text-[--secondaryThree-clr]">
                Forget Password?
              </a>
            </div>
          </form>
          <p className="text-center font-[poppins] text-base">
            ...
            <Link to="/signup" className="ml-2 font-medium underline">
              Register
            </Link>
          </p>
        </div>
