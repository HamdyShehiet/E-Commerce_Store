...
function Banner({ locale , changeLanguage}){
            ...
            <div className="container flex items-center mx-auto font-[Poppins]">
                ...
                <div className="w-full max-w-[100px]">      
                    <div className="relative">
                        <select defaultValue={locale} onChange={(e)=>changeLanguage(e.target.value)} name="languages" id="languages" className="w-full px-3 py-2 text-base font-medium bg-transparent text-[--textOne-clr] transition duration-300 ease border-none outline-none shadow-sm focus:shadow-md appearance-none cursor-pointer">
                            <option value="en" className="font-medium bg-white text-[--primaryTwo-clr]">English</option>
                            <option value="ar" className="font-medium bg-white text-[--primaryTwo-clr]">{locale === "en" ? "Arabic" : "العربية"}</option>
                        </select>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className={`absolute z-[-1] top-3  ${locale === "en" ? "right-1" : "left-3"} h-4 w-4`}>
