            ...
            <div className="container flex items-center mx-auto font-[Poppins]">
                ...
                <div className="w-full max-w-[100px]">      
                    <div className="relative">
                        <select defaultValue="en" onChange={(e)=> setLanguage(e.target.value)} name="languages" id="languages" className="w-full font-medium bg-transparent text-white text-base pl-1 pr-8 py-2 transition duration-300 ease border-none outline-none shadow-sm focus:shadow-md appearance-none cursor-pointer">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="absolute z-[-1] top-3 right-3 h-4 w-4 ">
